...
- `evidence/stage-0-baseline.schema.json` — machine-readable evidence contract; the measured record is committed after the implementation SHA exists.
- `package.json` — Bun entry points for the Stage 0 gates.
- `.github/workflows/ci.yml` — required Stage 0 schema, mutation, typecheck, and fixture gate.
